# Detects banned ips in SSH port and it sends a JSON to a server for Extended Distributed NAC (EDNAC) within ZTI project.Use only https connections for POST delivery of JSON.
#!/bin/bash
# Configuration
JAIL="sshd"                               # Jail to inspect
